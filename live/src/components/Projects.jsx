...
export default function Projects() {
  ...
  const projectItems = createMemo(() => projects());
  const learned = () => projectItems()[0];
  const fluent = () => projectItems()[1];
  const dealbreaker = () => projectItems()[2];
  const lightForm = () => projectItems()[3];
  const handoff = () => projectItems()[4];
  onMount(() => {
    const updateScroll = () => {
              ...
              <div class="project-info">
                ...
                <div class="project-links">
                  <a href={lightForm().links.website} target="_blank" rel="noopener" class="project-link project-link-site">
                    ...
                    {t().projects.actions.viewClientSite}
                  </a>
                </div>
              </div>
            </div>
